function registerSettings() {
	...
	game.settings.register("foundry-pf2e-monday-monsters-vol2", "popupVis", {
...
Hooks.once('ready', async function () {
    if (game.user.isGM) {
        if (game.settings.get("foundry-pf2e-monday-monsters-vol2", "popupVis") == true) {
            let d = new Dialog({
                title: "Premium Content Activated",

                content: `
                <h3>
								Thank you for purchasing Monday Monsters Volume 2: Beasts, Botany and Beyond  by Brett James Tomko!
								</h3>
								<p>
								This FoundryVTT module has been prepared by Avery for Eldritch Osiris Games, please report any bugs to:
								<a href="https://github.com/Eldritch-Osiris-Games/foundry-pf2e-monday-monsters-vol2/issues">GitHub</a>
								</p>
                `,
                buttons: {
                    one: {
                        label: "Close",
                        callback: () => game.settings.set("foundry-pf2e-monday-monsters-vol2", "popupVis", false)
                    },
                },
            },{ width: 450});
            d.render(true);
